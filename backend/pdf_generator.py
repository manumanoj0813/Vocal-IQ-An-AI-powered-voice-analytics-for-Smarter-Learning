...
class VoiceAnalysisPDFGenerator:
    ...
    def generate_voice_analysis_pdf(self, analysis_data: Dict[str, Any], user_info: Dict[str, Any] = None) -> bytes:
        ...
        try:
            ...
            # Optional: Explanations appendix
            try:
                if analysis_data.get('_include_explanations'):
                    story.append(PageBreak())
                    story.append(Paragraph("Understanding Your Scores", self.styles['SectionHeader']))
                    expl = [
                        ("Clarity", [
                            "Clear sounds: fewer mumbles or blurred words",
                            "Steady sound shape: less noise and muffling",
                            "Loud enough: voice stands above background noise",
                            "Less hiss/harshness: fewer scratchy sounds",
                        ]),
                        ("Stability", [
                            "Pitch: how much your voice note jumps around",
                            "Loudness: how even your volume stays",
                            "Average Pitch & Range: typical note and spread",
                            "Contour: smooth shape of your pitch curve",
                        ]),
                        ("Emotion Confidence", [
                            "How sure we are about the main emotion in your voice",
                        ]),
                        ("Speech & Rhythm", [
                            "Speech Rate: how fast you speak",
                            "Pause Ratio: how much silence you leave",
                            "Consistency: how steady your rhythm is",
                            "Stress Pattern: overall feel (dynamic or flat)",
                        ]),
                        ("Fluency", [
                            "Mix of smooth flow and signs like hesitations or repeated words",
                        ]),
                        ("AI Voice Risk (Enhanced)", [
                            "Checks for 'too perfect' patterns common in AI voices",
                        ]),
                        ("Language Confidence (Enhanced)", [
                            "We look at the sound of the language and a bit of text to guess",
                        ]),
                    ]
                    for title, items in expl:
